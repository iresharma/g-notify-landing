...
import { ReactComponent as BriefcaseIcon } from "feather-icons/dist/icons/activity.svg";
...
export default ({
  ...
  heading = (
    <>
      Making roads safer with <span tw="text-primary-500">Rewards.</span>
    </>
  ),
  description = "Building software to help people and make others life easier.",
  primaryButtonText = "Learn More",
  primaryButtonUrl = "https://g-notify.netlify.app",
  ...
  const defaultFeatures = [
    {
      Icon: BriefcaseIcon,
      title: "Health",
      description: "To save lives by instilling a sense of responsibility towards society in people by rewarding them for their good behaviour and compliance.",
      iconContainerCss: tw`bg-teal-300 text-teal-800`
    },
    {
      Icon: MoneyIcon,
      title: "Rewards",
      description: "To reward people who always obey the rules of law and act responsibly in public life where administration penalises people who break the rules.",
