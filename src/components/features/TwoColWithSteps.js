...
export default ({
  ...
  const defaultSteps = [
    ...
    {
      heading: "Create or Re-use",
      description: "Decide from the already present collection of crowd sourced templates or crate one."
    },
    {
      heading: "Add emails",
      description: "Create a list of recipients either by manually adding emails or uploading a csv."
    },
    {
      heading: "Send",
      description: "Press the big blue button to send it off ✈️."
    }
  ];
